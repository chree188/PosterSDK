...
```bash
git clone github.com/chree188/PosterSDK
go run main.go
```
![海报](build/poster_c8bi4cjq2lq1h80g85bg.png)
...
```bash
$ go get -u github.com/chree188/PosterSDK
...
import (
	...
	"github.com/chree188/PosterSDK/handler"
	"github.com/rs/xid"
)
...
```cgo
	...
	qrCodeHandler := &handler.QRCodeHandler{
		X:   30, // 二维码x坐标
		Y:   860,// 二维码y坐标
		URL: "https://github.com/chree188/PosterSDK", // 二维码跳转URL地址
	}
	//绘制文字
